                ...
                <Toolbar className={'Header'}>
                    ...
                    <Box sx={{flexGrow: 1}}>
                        <Grid container spacing={0} minHeight={40} maxHeight={40} minWidth={920} display="flex"
                            ...
                            <Grid mr={10}>
                                <Button onClick={() => navigate('/base')} className={'Button'} variant="text"><Typography
                                    className={'Typography'}>База</Typography></Button>
                            </Grid>
                            <Grid mr={10}>
                                <Button onClick={() => navigate('/talant')} className={'Button'} variant="text"><Typography
                                    className={'Typography'}>Талант</Typography></Button>
                            </Grid>
                            <Grid mr={10}>
                                <Button onClick={() => navigate('/graphics')} className={'Button'} variant="text"><Typography
